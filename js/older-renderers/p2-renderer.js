...
/* original taken from the ragdoll demo here -
hacked around wantonly.
http://schteppe.github.io/p2.js/demos/ragdoll.html
...
WebGLRenderer.prototype.init = function(){
   ...
   this.container.filters = [blurFilter];
    ...
    /*TEMP*/
    //testtext = PIXI.Texture.fromImage("bunny.png");
...
WebGLRenderer.prototype.addRenderable = function(obj){
   ...
   // var color = parseInt('0xff6600',16),
    ...
    /*var bunny = new PIXI.Sprite(testtext);
    bunny.width = bunny.height = .25;
    bunny.anchor.x = 0;
    bunny.anchor.y = 0; 
